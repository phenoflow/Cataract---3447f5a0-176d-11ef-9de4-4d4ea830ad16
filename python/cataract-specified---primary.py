...
codes = [{"code":"FyuE100","system":"readv2"},{"code":"F463000","system":"readv2"},{"code":"P330.00","system":"readv2"},{"code":"H26.9","system":"readv2"},{"code":"H26.8","system":"readv2"},{"code":"C74.8","system":"readv2"},{"code":"C74.9","system":"readv2"}];
REQUIRED_CODES = 1;
